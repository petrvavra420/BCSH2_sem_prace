...
{
    public class ZavodEditViewModel : ViewModelBase
    {
        ...
        public ZavodEditViewModel(LiteDatabase database, ICollectionModels polozka)
        {
            ZavodCisloPopisne = 12;
            ZavodPSC = 19016;
            Zavod zavod = (Zavod)polozka;
            zavodId = zavod.ZavodId;
            //Nastaví hodnoty textboxům dle vybraného závodu
            ZavodName = zavod.Name;
            ZavodStat = zavod.Adress.Country;
            ZavodMesto = zavod.Adress.City;
            ZavodUlice = zavod.Adress.Street;
            ZavodCisloPopisne = zavod.Adress.HouseNumber;
            ZavodPSC = zavod.Adress.PostalCode;
